...
import com.hofmannmachado.jwtrestapi.api.dtos.CadastroPJDto;
...
@RestController
@RequestMapping("${app.api.cadastrar-pj.url}")
...
public class CadastroPJController {
    ...
    private void validarDadosExistentes(CadastroPJDto cadastroPJDto, BindingResult result) {
        this.empresaService.buscarPorCnpj(cadastroPJDto.getCnpj())
                .ifPresent(emp -> result.addError(new ObjectError("empresa", "Empresa [" + emp.getCnpj() + "] já existente.")));

        this.funcionarioService.buscarPorCpf(cadastroPJDto.getCpf())
                .ifPresent(func -> result.addError(new ObjectError("funcionario", "CPF [" + func.getCpf() + "] já existente.")));

        this.funcionarioService.buscarPorEmail(cadastroPJDto.getEmail())
                .ifPresent(func -> result.addError(new ObjectError("funcionario", "Email [" + func.getEmail() + "] já existente.")));
    }
